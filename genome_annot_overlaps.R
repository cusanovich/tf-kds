...
#  }
  ...
  if(currtest == "GrepDistance"){
    ...
    boxplot(log10(abs(unlist(currtfdesb))+0.001),log10(abs(unlist(currtfboundsb))+0.001),col=c("indianred","dodgerblue2"),outline=F,
    ...
    boxplot(log10(abs(unlist(currdowndesb))+0.001),log10(abs(unlist(currdownboundsb))+0.001),col=c("indianred","dodgerblue2"),outline=F,
